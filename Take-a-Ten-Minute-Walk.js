...
function isValidWalk(walk) {
  ...
  walk.forEach((element) => {
    if (element === "n") position.vertical++;
    if (element === "s") position.vertical--;
    if (element === "w") position.horizontal--;
    if (element === "e") position.horizontal++;
  });

  return position.vertical === 0 && position.horizontal === 0 ? true : false;
}
